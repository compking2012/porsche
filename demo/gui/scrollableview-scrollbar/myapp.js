...
Class.define("MyApp", App, {
    onStart: function() {
        ...
        scrollableView.horizontalScrollBar = new ScrollBar();
        scrollableView.horizontalScrollBar.orientation = "horizontal";
        scrollableView.horizontalScrollBar.top = 310;
        scrollableView.horizontalScrollBar.width = 50;
        scrollableView.horizontalScrollBar.height = 10;
        this.window.addChild(scrollableView.horizontalScrollBar);

        scrollableView.verticalScrollBar = new ScrollBar();
        scrollableView.verticalScrollBar.left = 310;
        scrollableView.verticalScrollBar.width = 10;
        scrollableView.verticalScrollBar.height = 50;
        this.window.addChild(scrollableView.verticalScrollBar);
