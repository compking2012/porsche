...
function addAttribs(f) {
    ...
    f.attribs = '<span class="type-signature">'+attribs.length? attHTML: ''+'</span>';
}
    ...
    for (var longname in helper.longnameToUrl) {
        if ( hasOwnProp.call(helper.longnameToUrl, longname) ) {
            ...
            if (myNamespaces.length) {
                generate('<i class="icon-code"></i> ' + myNamespaces[0].name, myNamespaces, helper.longnameToUrl[longname]);
            }
