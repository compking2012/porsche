...
Class.define("framework.ui.view.QRCode", View, {
    ...
    getQRCodeDraw: function() {
        ...
        function fixed_cca(str, idx) {
            idx = idx || 0;
            var code = str.charCodeAt(idx), lo, hi;
        ...
        */
        ...
        QRCodeDraw.prototype = {
            ...
            draw: function(context, text, options) {
                ...
                //create qrcode!
                try {
                    var qr = new QRCode(level, errorCorrectLevel);
            ...
            QRVersion: function(text, errorCorrectLevel, version) {
                ...
                return {text: text, version: version, errorCorrectLevel: errorCorrectLevel};
            },
